...
`;
const QueryClaimStatistics = () => {
  return (
    <QueryClaimStatisticsStyles>
      <AppContainer>
        <TopHeader
          pageName="NFT Lookup / Query Claim Statistics"
          showTime={true}
        ...
        <AppFlexContainer>
          <LeftMenu />
          <RightContentBox>
            <h4>Query Claim Statistics</h4>
            <div className="qcs-top-grid">
...
export default QueryClaimStatistics;
